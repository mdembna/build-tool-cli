<template>
  <div class="mdb-vue-date">
    <div class="datepickbox">
      <mdb-input type="text" :title="mdbOptions.title" :label="mdbOptions.label" class="mdb-datepicker" readonly="readonly" :placeholder="value || mdbOptions.placeholder" v-model="date.time" :required="required" @keydown.native.enter.stop="showCheck" @click.native="showCheck" @focus.native="showCheck" @change="emitDate" />
    </div>
